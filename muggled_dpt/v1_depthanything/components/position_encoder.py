...
class PositionEncoder(nn.Module):
    ...
    def __init__(self, features_per_token: int, base_patch_grid_hw: tuple[int, int], enable_cache: bool = True):
    ...
    def _apply_cls_embedding(self, cls_token: Tensor) -> Tensor:
        """
    ...
    def _get_position_embedding(self, patch_grid_hw: tuple[int, int]) -> Tensor:
    ...
    def _scale_to_patch_grid(self, patch_grid_hw: tuple[int, int]) -> Tensor:
        ...
        pos_embed_imagelike_bchw = nn.functional.interpolate(
            pos_embed_imagelike_bchw, size=patch_grid_hw, mode="bicubic", antialias=False
        )
