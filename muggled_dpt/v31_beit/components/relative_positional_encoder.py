...
class RelativePositionEncoding(nn.Module):
    ...
    def __init__(self, num_heads: int, reference_patch_grid_hw: tuple[int, int] = (32, 32)):
    ...
    def forward(self, attention_tensor: Tensor, patch_grid_hw: tuple[int, int]) -> Tensor:
        """
    ...
    def update_cache(self, patch_grid_hw: tuple[int, int] | None = None) -> bool:
        """
    ...
    def _get_position_bias(self, patch_grid_hw: tuple[int, int]) -> Tensor:
        """
    ...
    @staticmethod
    def _generate_relative_position_index(
    ...
    def _generate_position_bias_lut(self, patch_grid_hw: tuple[int, int]) -> Tensor:
        """
    ...
    @staticmethod
    def calculate_bytes_per_layer(
        num_heads: int,
        patch_grid_hw: tuple[int, int],
        bytes_per_bias_element: int = 4,
    ) -> int:
        """
    ...
    def extra_repr(self) -> str:
        ...
        return f"num_heads={self.num_heads}, reference_patch_grid_hw={self.reference_patch_grid_hw}"
...
class GridCache(nn.Module):
    ...
    def check_is_cached(self, patch_grid_hw: tuple[int, int]) -> bool:
    ...
    def store_bias(self, relative_position_bias: Tensor, patch_grid_hw: tuple[int, int]) -> None:
    ...
    def retrieve_bias(self, patch_grid_hw: tuple[int, int]) -> tuple[bool, Tensor]:
    ...
    @staticmethod
    def _make_cache_key(grid_hw: tuple[int, int]) -> str:
        return f"h{grid_hw[0]}w{grid_hw[1]}"
    ...
    def extra_repr(self) -> str:
        ...
        if self.bias_cache is not None:
            ...
            bias_str = f"bias={bias_shape_str}"
