...
class LoopingVideoReader:
    ...
    def __init__(self, video_path: str, display_size_px: int = 800):
        ...
        if not rec_frame:
            raise IOError("Can't read frames from video!")
    ...
    def scale_to_display_wh(self, image: ndarray) -> ndarray:
    ...
    def get_playback_position(self, normalized: bool = True) -> int | float:
    ...
    def set_playback_position(self, position_0_to_1: float) -> int:
...
class PlaybackIndicatorCB:
    ...
    def __init__(self, vreader: LoopingVideoReader, bar_height: int = 60, enabled: bool = True):
