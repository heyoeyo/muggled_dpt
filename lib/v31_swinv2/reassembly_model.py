...
class ReassembleModel(nn.Module):
    ...
    def __init__(self, hidden_channels_list: tuple[int, int, int, int], num_output_channels: int):
...
class ReassembleBlock(nn.Module):
    ...
    def __init__(self, num_hidden_channels: int, num_output_channels: int, downscale_factor: int = 1):
