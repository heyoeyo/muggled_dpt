...
class RelativePositionEncoding(nn.Module):
    ...
    def forward(self, attention_tensor: Tensor, window_size_hw: tuple[int, int]) -> Tensor:
        return attention_tensor + self._get_position_bias(window_size_hw)

    # .................................................................................................................

    def _get_position_bias(self, window_size_hw: tuple[int, int]) -> Tensor:
        """
    ...
    def _get_coords_table(self, window_size_hw: tuple[int, int]) -> Tensor:
    ...
    def _get_position_index(self, window_size_hw: tuple[int, int]) -> Tensor:
    ...
    @staticmethod
    def _make_relpos_index(window_size_hw: tuple[int, int], device: torch.device | None = None) -> Tensor:
        """
...
class GridCache(nn.Module):
    ...
    def check_is_cached(self, grid_hw: tuple[int, int]) -> bool:
    ...
    def store_tensor(self, tensor_data: Tensor, grid_hw: tuple[int, int]) -> None:
        if self._is_enabled:
    ...
    def retrieve_tensor(self, grid_hw: tuple[int, int]) -> tuple[bool, Tensor]:
