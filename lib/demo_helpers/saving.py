...
def save_image(
    ...
    save_name = f"{name_only}_{save_time}.png"
    ...
    try:
        ...
        print("", "Error trying to save depth image...", str(err), sep="\n", flush=True)

    return ok_save, save_path


def save_numpy_array(numpy_array: ndarray, save_path: str) -> tuple[bool, str]:
    """
    ...
    try:
        ...
        print("", "Error trying to save numpy array...", str(err), sep="\n", flush=True)

    return ok_save, save_path_npy


def save_uint16(numpy_array: ndarray, save_path: str) -> tuple[bool, str]:
    """
    ...
    try:
        ...
        print("", "Error trying to save uint16 image...", str(err), sep="\n", flush=True)
