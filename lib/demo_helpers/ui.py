...
class SliderCB:
    ...
    def __init__(
        ...
        marker_step_size: float | None = None,
        bar_height: int = 40,
        enable_value_display: bool = True,
        bar_bg_color: tuple[int, int, int] = (40, 40, 40),
    ...
    def set(self, slider_value: float, use_as_default_value: bool = True):
    ...
    def on_keypress(self, keypress_code: int, decrement_keycode: int, increment_keycode: int):
    ...
    def append_to_frame(self, frame: ndarray) -> ndarray:
    ...
    def _update_base_image(self, frame_h: int, frame_w: int) -> ndarray:
    ...
    @staticmethod
    def append_many_to_frame(frame: ndarray, *sliders) -> ndarray:
        for s in sliders:
...
class ColormapButtonsCB:
    ...
    def __init__(self, *cv2_colormap_codes, bar_height: int = 40):
    ...
    def prepend_to_frame(self, frame: ndarray) -> ndarray:
    ...
    def draw_bar_image(self, frame_w: int) -> ndarray:
        """Helper used to set up base image sizing & interaction region"""
    ...
    def apply_colormap(self, image_uint8_1ch: ndarray) -> ndarray:
        return self.apply_given_colormap(image_uint8_1ch, self._cmap_select)

    # .................................................................................................................

    @staticmethod
    def apply_given_colormap(image_uint8_1ch: ndarray, colormap_code_or_lut: int | ndarray | None) -> ndarray:
        """
    ...
    @staticmethod
    def make_gray_colormap(num_samples: int = 256) -> ndarray:
    ...
    @staticmethod
    def make_spectral_colormap(num_samples: int = 256) -> ndarray:
        """
...
class ButtonBar:
    ...
    def __init__(self, bar_height: int = 36):
    ...
    def add_button(self, label: str = "Button", keypress: int | str | None = None):
    ...
    def make_disabled_button(self, read_value: bool = True):
        """
    ...
    def set_y_offset(self, y_offset_px: int):
        self._interact_y_offset = y_offset_px
        return self

    # .................................................................................................................

    def _make_base_image(self, bar_width: int) -> ndarray:
    ...
    def draw_standalone(self, frame_width: int) -> ndarray:
        """
    ...
    def on_keypress(self, keypress_code: int):
...
class _ToggleControl(ButtonBar.Control):
    ...
    def on_keypress(self, keypress_code: int | None):
    ...
    def make_image(self, button_height: int, button_width: int) -> ndarray:
...
class _ButtonControl(ButtonBar.Control):
    ...
    def __init__(self, on_change_callback, label: str = "Button", keypress: int | str | None = None):
        self._on_change_cb = on_change_callback
        self._state = False
        self._label = label
        self._keypress = ord(keypress) if isinstance(keypress, str) else keypress
    ...
    def on_keypress(self, keypress_code: int | None) -> bool:
