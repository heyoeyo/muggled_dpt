...
class GLData {
	...
	create_new_program = (is_metric_depth=false, use_depth_texture=false) => {
		...
		this.uniloc.scaling = gl.getUniformLocation(program, this._shader_defs.uniforms.scaling_factors);
		this.uniloc.camparam = gl.getUniformLocation(program, this._shader_defs.uniforms.camera_params);
