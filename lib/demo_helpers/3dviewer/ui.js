...
const SLIDER_CONTAINER_CSS_CLASS = "sliderui_container";
const TOGGLE_CONTAINER_CSS_CLASS = "toggleui_container";
const TOGGLE_BUTTON_CSS_CLASS = "toggleui_btn";
...
class SliderUI {
    ...
    constructor(
        ...
        this.container.classList.add(SLIDER_CONTAINER_CSS_CLASS);
...
class ToggleUI {
    ...
    constructor(parent_elem, label, initial_state = false) {
        ...
        this.togbtn_elem.classList.add(TOGGLE_BUTTON_CSS_CLASS);
        ...
        this.container = document.createElement("div");
        this.container.classList.add(TOGGLE_CONTAINER_CSS_CLASS);
        this.container.appendChild(this.label_elem);
