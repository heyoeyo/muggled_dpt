...
def make_swinv2_dpt(
    features_per_stage: tuple[int, int, int, int],
    heads_per_stage: tuple[int, int, int, int],
    layers_per_stage: tuple[int, int, int, int],
    base_patch_grid_hw: tuple[int, int],
    window_size_hw: tuple[int, int],
    pretrained_window_sizes_per_stage: tuple[int, int, int, int],
    ...
    **unused_kwargs,
    ...
    patch_embed_model = PatchEmbed(features_per_patch, patch_size_px, img_training_size)
    imgenc_model = SwinV2Model4Stages(
        features_per_stage,
        heads_per_stage,
        layers_per_stage,
        window_size_hw,
        pretrained_window_sizes_per_stage,
        enable_cache,
    )
