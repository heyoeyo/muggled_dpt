...
parser.add_argument("-i", "--image_path", default=default_image_path, help="Path to sample image for onnx export")
...
print("", f"Creating onnx model! ({orig_model_name})", "This may take a while...", "", sep="\n", flush=True)
...
if enable_save:
    ...
    print("", "Saved onnx model!", f"@ {save_path}", sep="\n")
