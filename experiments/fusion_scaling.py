...
from muggled_dpt.demo_helpers.postprocess import scale_prediction, normalize_01, histogram_equalization
...
with window.auto_close():
    ...
    while True:
        ...
        if save_btn.read():
            ...
            ok_img_save, save_img_path = save_image(depth_color, loaded_img_path, save_folder=save_folder)
